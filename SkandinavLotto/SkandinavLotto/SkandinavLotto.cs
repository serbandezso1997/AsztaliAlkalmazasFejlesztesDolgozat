...
{
    public partial class SkandinavLotto : Form
    {
       // int valaszt = 0;

        HashSet<string> szamok = new HashSet<string>();
        HashSet<int> generaltSzamok = new HashSet<int>();
        string[] SzamokTomb = new string[7];
        int[] SzamokTombInt = new int[7];
        int talaltokSzama = 0;

        public static SkandinavLotto Instance;
        ...
        private void Valaszt(object sender, EventArgs e)
        {
            ...
            //A felhasználó által választott számok betöltése tömbbe
        ...
        private void LottoSzamokBekuldese(object sender, EventArgs e)
        {
            ...
            //A felhasználó által választott számok sorrendbe állítása
            valasztottSzamokSorrendbe.Sort();
            //A már sorrendbe állított számok betöltése tömbbe
            ...
            ValasztottHetedik.Items.Add(SzamokTombInt[6]);
            ...
            GepSzam7.Items.Add(GeneraltSzamokTomb[6]);
            ...
            TorlesGomb.Enabled = false;
            /*
            foreach (var szamok in szamok)
            {
                ValasztottElso.Items.Add(szamok);
            }
            */
        }
